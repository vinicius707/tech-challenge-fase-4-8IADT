...
| 6 Modalidades | [`../specs/epic-06-modalidades/02-audio-azure.md`](../specs/epic-06-modalidades/02-audio-azure.md) | Pendente (spec fina E6.2) |
...
| 6 | Modalidades PDF | Em andamento (E6.1 ok; E6.2 áudio em andamento; falta E6.3) |
