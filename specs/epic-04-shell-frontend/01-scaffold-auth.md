...
**Spec aprovada (T4.0).** Implementação: **T4.1–T4.3**.
...
- [ ] Scaffold Next + Tailwind + shadcn commitado e documentado.
- [ ] Proxy `/api` configurado; Compose/README atualizados se necessário.
